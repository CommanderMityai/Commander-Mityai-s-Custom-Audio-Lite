...
local function GetCustomSpellOptions(spellIndex)
    ...
    return {
        ...
        args = {
            enabled = {
                type = "toggle", name = "Включено", width = "full",
                get = function() return spellConfig.enabled end,
                set = function(_, value) spellConfig.enabled = value end,
                order = 1,
            },
            spellId = {
                type = "input", name = "ID спелла", desc = "C вики, или аддон idTip в помощь (например: 2825, 1943, 133)", width = "full",
            ...
            source = {
                type = "select", name = "Откуда долбит", width = "double",
                values = { ["custom"] = "Долбит нормально", ["shared"] = "Блютуз колонка", ["random"] = "Долбит рандомно" },
            ...
            customPath = {
                type = "input", name = "Путь к файлу", desc = "Путь относительно Interface\\AddOns (без расширения .mp3)", width = "double",
            ...
            randomPath = {
                type = "input", name = "Путь к папке",  desc = "Путь к папке, хуле не понятно (например: Sounds\\Random)", width = "double",
            ...
            randomMax = {
                type = "range", name = "Количество долбежа", desc = "Сколько файлов в папке (например: 1.mp3, 2.mp3, n+1.mp3, ...)",
                min = 1, max = 10, step = 1, bigStep = 1,
            ...
            test = {
                type = "execute", name = "Че реально работает?",  desc = "Воспроизвести выбранный звук",
                func = function()
            ...
            remove = {
                type = "execute", name = "|cffff0000Удалить спелл|r", desc = "Удалить этот спелл из списка",
                func = function()
...
local function GetCustomAuraOptions(auraIndex)
    ...
    return {
        ...
        args = {
            ...
            auraId = {
                type = "input", name = "ID ауры", desc = "С вики, или аддон idTip в помощь (например: 2825, 1943, 133)", width = "full",
            ...
            remove = {
                type = "execute", name = "|cffff0000Удалить ауру|r",
                func = function()
...
CustomAudioLiteOptions = {
    ...
    args = {
        ...
        combatRez = GetSoundOptions("combatRez", "Боевое воскрешение", "Срабатывает когда ЛЮБОЙ игрок в группе/рейде использует комбат-рес в данже/рейде (Друид, ДК, ЧМ, Паладин, Инженер), бета функция, мб не все айди добавлены"),
        loot = {
            type = "group",
            name = "Лут",
            args = {
                rareLootRare = GetSoundOptions("rareLootRare", "Редкие предметы", "Рарочка выпала"),
                rareLootEpic = GetSoundOptions("rareLootEpic", "Эпические предметы и выше", "Ого не мои статы"),
            },
        },
        raidEnterDungeon = GetSoundOptions("raidEnterDungeon", "Вход в данж", "Пора."),
        raidEnterRaid = GetSoundOptions("raidEnterRaid", "Вход в рейд", "У лохов нет курвы"),
        customSpells = {
            type = "group",
            ...
            args = {
                ...
                addSpell = {
                    ...
                    func = function()
                        local newSpell = {
                            ...
                            shared = { value = "None" },
                            custom = { path = "Interface\\AddOns\\CommanderMityaisCustomAudioLite\\sounds\\", customType = "file", max = 1, isRandom = { enabled = true, currentFile = 1 } },
                        }
                ...
                spacer2 = { type = "description", name = "  ", order = 4 },
                spellsContainer = { type = "group", name = "Список спеллов", inline = true, order = 5, args = {} },
            },
        },
        customAuras = {
            type = "group",
            ...
            args = {
                ...
                spacer2 = { type = "description", name = "  ", order = 4 },
                aurasContainer = { type = "group", name = "Список аур", inline = true, order = 5, args = {} },
            },
        },
        zzz_about = {
            type = "group",
...
-- Регистрация опций + слэш-команда /cal
